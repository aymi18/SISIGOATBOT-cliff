...
module.exports = {
				...
				langs: {
								...
								en: {
												help: "█▄█ █░█ █▄░█ █▀█
░█░ █▄█ █░▀█ █▄█\n\n╔⏤⏤⏤╝🤴╚⏤⏤⏤╗\n      %6\n\n%1\n\nPage [ %2/%3 ]\nCurrently, The Bot has %4 Commands \n\n 🔱 » Type %5help <page> \n 🕶️ » Type %5help <command> \n\n \n",
												help2: "%1├───────🕶️\n│ » Currently, the bot has %2 commands that can be used\n│ » Type %3help <command name> to view the details of how to use that command\n│ %4\n╰─────────────🤴",
												commandNotFound: "Pasensya na honey, \"%1\" wala sa command ko toh, My Apologies 😓",
								...
								if (!command && !args[0] || !isNaN(args[0])) {
												...
												if (sortHelp == "name") {
																...
																arrayInfo.forEach((data, index) => {
																				const categoryUpcase = `${index == 0 ? `╭` : `├`}─── ${data.category.toUpperCase()} ${index == 0 ? "🤴" : "🕶️"}`;
